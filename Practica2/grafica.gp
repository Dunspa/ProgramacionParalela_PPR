...
plot "resultados/tiempos_1d.dat" using 1:2 title "tSec" with lp ps 2, \
 "resultados/tiempos_1d.dat" using 1:3 title "tParalelo (P=4)" with lp ps 2, \
  "resultados/tiempos_1d.dat" using 1:6 title "tParalelo (P=9)" with lp ps 2
